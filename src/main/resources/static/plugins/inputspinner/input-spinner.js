    ...
    $.fn.inputSpinner = function (methodOrProps) {
        ...
        var props = {
            ...
            template: // the template of the input
                '<div class="input-group ${groupClass}" style="width: 130px;">' +
                '<button style="width: ${buttonsWidth}" class="btn btn-decrement btn-minus" type="button">${decrementButton}</button>' +
                '<input type="text" inputmode="decimal" style="text-align: ${textAlign}; border:none; background: transparent" class="form-control form-control-text-input"/>' +
                '<button style="width: ${buttonsWidth}" class="btn btn-increment btn-plus" type="button">${incrementButton}</button>' +
                '</div>'
        }
